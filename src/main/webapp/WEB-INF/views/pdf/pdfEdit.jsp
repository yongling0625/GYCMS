    ...
    <div data-options="region:'center',border:false" title="" style="overflow: hidden;padding: 3px;">
        <form id="pdfEditForm" method="post">
            <table class="grid">
                <tr>
                    <td>PDF名称</td>
                    <td><input name="id" type="hidden"  value="${pdfInfo.id}"/>
	                    <input name="pdfAddress" type="hidden"  value="${pdfInfo.pdfAddress}"/>
	                    <input name="pictureAddress" type="hidden"  value="${pdfInfo.pictureAddress}"/>
                    <input name="title" type="text" placeholder="请输入PDF名称" class="easyui-validatebox" data-options="required:true" value="${pdfInfo.title}"></td>
                </tr>
                <tr>
                    <td>产品分类</td>
                    <td>
